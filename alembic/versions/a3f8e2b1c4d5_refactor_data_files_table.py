...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['type_code'], ['data_types.code'], ondelete='RESTRICT'),
        sa.ForeignKeyConstraint(['station_code'], ['stations.code'], ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('file_path'),
    )
    op.create_index(op.f('ix_files_id'), 'files', ['id'], unique=False)
    op.create_index(op.f('ix_files_type_code'), 'files', ['type_code'], unique=False)
    op.create_index(op.f('ix_files_station_code'), 'files', ['station_code'], unique=False)
